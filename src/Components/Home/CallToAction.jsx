...
const CallToAction = () => {
  return (
    <section className='mt-10'>
        <div className="max-w-5xl mx-2 md:mx-auto p-px rounded-2xl bg-gradient-to-r from-purple-600/20 to-indigo-500/30">
            <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3EAFF] to-[#E1EFFF]">  
                <div className="flex items-center justify-center bg-white px-3 py-1.5 shadow gap-1 rounded-full text-xs">
                    ...
                    <span className="bg-gradient-to-r from-purple-600 to-indigo-500 bg-clip-text text-transparent font-medium">Trusted by 40+ Businesses</span>
                </div>
                <h2 className="text-2xl md:text-4xl font-medium mt-2 leading-[1.2]">
                    Stop chasing payments. Start getting paid <br />with
                    <span className="bg-gradient-to-r from-purple-600 to-indigo-500 bg-clip-text text-transparent"> ArthaAI </span> 
                    & Smart Invoicing.
                </h2>
                <p className="text-slate-500 mt-2 max-w-lg max-md:text-sm">ArthaAI turns invoice chaos into a clean, automated workflow — from creation to collection.</p>
                <button type="button" className="bg-gradient-to-r from-purple-600 to-indigo-500 text-white text-sm px-5 py-2.5 rounded-xl font-medium mt-4 hover:scale-105 active:scale-95 transition-all duration-300"> 
                    Get Started Today
                </button>
            </div>
        </div>
