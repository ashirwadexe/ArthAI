...
const TrustedBrands = () => {
    ...
    return (
        <>
            ...
            <div className="mt-10 overflow-hidden w-full relative max-w-5xl mx-auto select-none">
                <p className="py-6 text-slate-600 mt-14 text-center">Trusted by leading brands, including</p>
                    ...
                    <div className="flex">
                        {[...companyLogos, ...companyLogos].map((company, index) => (
                            <img key={index} src={`https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/companyLogo/${company}.svg`}
                                alt={company} className="w-full h-10 object-cover mx-6" draggable={false} />
                        ))}
                    </div>
                </div>
